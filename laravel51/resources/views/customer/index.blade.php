...
<div class="container">
    ...
    <div class="table">
        <table class="table table-bordered table-striped table-hover">
            <thead>
                <tr>
                    <th>#</th><th> {{ trans('customer.name') }} </th><th> {{ trans('customer.addr') }} </th><th> {{ trans('customer.sex') }} </th><th> {{ trans('customer.sex') }} </th><th> {{ trans('customer.created_at') }} </th><th>Actions</th>
                </tr>
            </thead>
            <tbody>
                {{-- */$x=0;/* --}}
